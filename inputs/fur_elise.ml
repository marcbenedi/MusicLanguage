//http://1.bp.blogspot.com/-gsi-JzTPoCQ/TgTbN2QE1iI/AAAAAAAABzY/2qlCImjVGHg/s1600/Para+Elisa+de+Beethoven+Piano.mscz-1.png
func main()
  part1();
  part2();
endfunc
...
Piezzo part2()
  Partitura {
    Tempo n = 120
    Compas 3:4
    Voice Piano ||: La Silenci.c Do.c Mi.c La.c
   ...
   Voice Piano  ||: 4La.c 4Mi.c 4La.c  Silenci.c Silenci.n
